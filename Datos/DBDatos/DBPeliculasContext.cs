...
namespace Datos.Data
{
    public class DBPeliculasContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Clasificacion>().Property(e => e.Descripcion).HasColumnType("varchar").HasMaxLength(3).IsRequired();
            modelBuilder.Entity<Clasificacion>().Property(e => e.Tipo).HasColumnType("varchar").HasMaxLength(30).IsRequired();
